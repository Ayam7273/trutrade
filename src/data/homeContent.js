...
export const heroContent = {
  headline: 'Secure Escrow & Payment Platform for Marketplaces',
  headlineLines: ['Secure Escrow & Payment Platform for', 'Marketplaces'],
  subtext:
    'Escrow for the UK ⇄ Nigeria trade corridor. Building trust, fulfilling needs easily.',
  cta: 'Get Started',
};
...
export const infraContent = {
  badge: '01',
  title: 'Escrow Infrastructure for Securing Digital Transactions',
  body: 'Trutrade helps online businesses across the UK and Nigeria hold funds securely, release payments on completion, and scale trust across both parties in a transaction.',
  image: '/assets/images/homepage-img1.png',
  imageAlt: 'Illustration of a locked shield and certified document representing secure escrow.',
};
...
export const newsletterContent = {
  ...
  image: '/assets/images/newsletter-img.png',
};
